...
"""
  ...
  Code by : AdamJB
  Info    : https://code.google.com/codejam/contest/2974486/dashboard#s=p2

  Note: This only solves the small problem set, not the large one.
  I'm brute forcing all possible boards to see whether it's impossible or not...
